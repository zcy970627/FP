...
def FindNeighbor(start_pt):
    ...
    if pos1 == 11:
        ...
        for m1 in range(start_pt[2][2]):
            while start_pt[2][3][m1] > (4096 // start_pt[2][2]):
                start_pt[2][3][m1] = start_pt[2][3][m1] // 2
...
if __name__ == "__main__":
    ...
    for i in range(5):
        ...
        ax.set_ylabel('MaxDE')
        ax.set_xlabel('Power')
        plt.savefig('/work/publications/norcas2020/experiments/results/4/3dPareto'+str(i+1)+'.png')
        plt.show()

        for k in range(0, len(pareto_front)):
            plt.plot(pareto_front[k][0],pareto_front[k][1],"+r")
        plt.savefig('/work/publications/norcas2020/experiments/results/4/2dPareto'+str(i+1)+'.png')
        plt.show()

        f = open('/work/publications/norcas2020/experiments/results/4/hv_list'+str(i+1)+'.pkl','wb')
        pickle.dump(hv_list,f)
        f.close()

        f = open('/work/publications/norcas2020/experiments/results/4/P'+str(i+1)+'.pkl','wb')
        pickle.dump(P,f)
        f.close()

        f = open('/work/publications/norcas2020/experiments/results/4/ParetoFront'+str(i+1)+'.pkl','wb')
        ...
        plt.savefig('/work/publications/norcas2020/experiments/results/4/Convergence'+str(i+1)+'.png')
        plt.show()

    file = open('/work/publications/norcas2020/experiments/results/4/HV4.txt','w')
    for hv in hv_all:
        file.write(str(hv))
        file.write('\n')
    file.write('Average Hypervolume of Neighbor Function 4 after 40000 Generations is')
    file.write('\b')
